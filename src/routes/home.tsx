    ...
    return (
        <div className="flex-col w-full pb-24">
            <Container>
                ...
                {/* image section */}
                <div className="w-full mt-4 rounded-xl bg-gray-100 h-[740px] drop-shadow-md overflow-hidden relative">
                    <img
                        src="/assets/img/cartoon-ai-robot-scene.jpg"
                        alt=""
            ...
            <Container className="py-8 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
                    <div className="col-span-1 md:col-span-3">
                        <img
                            src="/assets/img/10209732.jpg"
                            alt=""
                            className="w-full max-h-200 rounded-md object-cover"
                        />
                    </div>
